...
const Newarrivalmen = () => {
  return (
    <div>
        ...
        <Image src="/Image/gentsperfume8.jpg" alt="gents perfume" width={300} height={300}/>
        <h1 className="text-sm font-semibold text-center">Eternity</h1>
        <p className="text-sm font-semibold text-center">Price: Rs.4300/-</p>
